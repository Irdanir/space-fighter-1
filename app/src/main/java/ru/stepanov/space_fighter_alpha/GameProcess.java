...
public class GameProcess extends SurfaceView implements Runnable {
    ...
    final MediaPlayer shootingsound;
    final MediaPlayer hitsound;
    final MediaPlayer victorysound;

    Context context;

    public GameProcess(Context context, int screenX, int screenY) {
        super(context);
